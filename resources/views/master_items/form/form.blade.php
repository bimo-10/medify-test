<form method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        @if (isset($item->foto) && $item->foto)
            <div class="mt-2">
                <img src="{{ asset('storage/foto_master_items/' . $item->foto) }}" alt="Foto"
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="kategori[]" multiple>
            @php
                $selectedKategori = isset($item->kategoriItems) ? $item->kategoriItems->pluck('id')->toArray() : [];
                $allKategori = \App\Models\KategoriItem::all();
            @endphp
